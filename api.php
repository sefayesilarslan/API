<?php
    ...
    if ($veriler["token"] != sha1(md5("sefa"))) {
    ...
    if ($talep == "GET") {
        ...
        if ($sorgu->rowCount() > 0) {
            ...
            islem($ogrenciler, 200, "Kayıt Listelendi!");
        } else {
        ...
        if ($sorgu->rowCount() > 0){
            islem(array($veriler), 200, "Kayıt Eklendi!");
        } else {
        ...
        if ($sorgu->rowCount() > 0){
            islem(array($veriler), 200, "Kayıt Güncellendi!");
        } else {
        ...
        if ($sorgu->rowCount() > 0){
            islem(array($veriler), 200, "Kayıt Silindi!");
        } else {
